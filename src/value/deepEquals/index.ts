 ...
 */
export const deepEquals = (valueOne: any, valueTwo: any): boolean => {
  ...
  if (Array.isArray(valueOne) && Array.isArray(valueTwo)) {
    ...
    return valueOne.every((item, index) => deepEquals(item, valueTwo[index]))
  }
  ...
  if (typeof valueOne === "object" && typeof valueTwo === "object") {
    ...
    return valueOneKeys.every(key => deepEquals(valueOne[key], valueTwo[key]))
  }
