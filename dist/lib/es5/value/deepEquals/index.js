 ...
 */
var deepEquals = function (valueOne, valueTwo) {
    ...
    if (Array.isArray(valueOne) && Array.isArray(valueTwo)) {
        ...
        return valueOne.every(function (item, index) { return (0, exports.deepEquals)(item, valueTwo[index]); });
    }
    // Handle Objects
    if (typeof valueOne === "object" && typeof valueTwo === "object") {
        ...
        return valueOneKeys.every(function (key) { return (0, exports.deepEquals)(valueOne[key], valueTwo[key]); });
    }
